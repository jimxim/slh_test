...
// run("【销售开单-开单】检查核销", "test170065_1");//未付不会点击
...
// run("【销售开单-开单】异地+代收，检查库存变化", "test170671");//getQueryBtnIndex
// run("【销售开单-开单】已作废的抵现单不能再显示", "test170693");//value.replace
// run("【销售开单-开单】均色均码模式+异地发货模式/异地+代收，库存检查", "test170722");
// run("【销售开单-开单】均色均码模式+异地发货模式/异地+代收，库存检查", "test170722_1");//异地发货
