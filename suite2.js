...
// run("【销售开单-开单】销售单已配货的单子只允许修改付款方式--只允许修改付款方式", "test170559_170697");
 ...
 run("【销售开单-按汇总-按客户汇总】按品牌,统计客户到店频率及品牌拿货频率", "test170718");//闪退
    run("【销售开单－按批次查】是否未结", "test170005");// ///
    run("【销售开单－按批次查】作废挂单 输入条件检查", "test170006");
// run("【销售开单-按批次查】退货，需要排除本单的退货数再验证是否超出购买数", "test170454");//新增货品失败，产品折扣位置输入错误
 // run("【销售开单－开单】产品折扣,复制-粘贴", "test170139_2");//新增货品失败
// run("【销售开单-核销】物流核销时待核销物流单选择界面---日期和客户查询条件查询", "test170577");//不弹出提示语
// run("【销售开单－开单】退货时备注显示", "test170096");//新增货品失败
    
// run("【销售开单－开单】开单时不允许负库存", "test170116_170660");//新增货品失败
