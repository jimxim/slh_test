...
function test170273() {
    ...
    var json = { "客户" : "lt",
        ...
        "特殊货品" : { "免单" : 9, "打包费" : 100 }, "onlytest" : "yes" };
    editSalesBillNoColorSize(json);
    var qr = getQRDet();
    var inprice = qr.data[0]["单价"];
    var inprice1 = qr.data[1]["单价"];
    var money = add(Math.round(add(inprice * 5 * 1.5, inprice1 * 8 * 1.3)), 91);
