...
function test170626() {
    ...
    tapMenu("销售开单", "开  单+");
    var json = { "客户" : "ls",
        "明细" : [ { "货品" : "x001", "数量" : [ 0, 0, 0, 1 ] } ], "onlytest" : "yes" };
    editSalesBillColorSize(json);

    var ret1 = isEqual("铁锈红", getTextFieldValue(getScrollView(-1), 22));

    tapReturn();

    tapMenu("销售订货", "新增订货+");
    var json = { "客户" : "lt",
        "明细" : [ { "货品" : "x001", "数量" : [ 0, 0, 0, 1 ] } ],
        "goodsFieldIndex" : -2, "onlytest" : "yes" };
    editSalesBillColorSize(json);

    var ret2 = isEqual("铁锈红", getTextFieldValue(getScrollView(-1), 25));
    ...
    var ret3 = isEqual("铁锈红", getTextFieldValue(getScrollView(-1), 25));
    ...
    var ret4 = isEqual("铁锈红", getTextFieldValue(getScrollView(-1), 22));
    ...
    var ret5 = isEqual("铁锈红", getTextFieldValue(getScrollView(-1), 16));

    tapReturn();

    tapMenu("盘点管理", "新增盘点+");
    var json = { "明细" : [ { "货品" : "x001", "数量" : [ 0, 0, 0, 1 ] } ],
        "goodsFieldIndex" : -2, "onlytest" : "yes" };
    editSalesBillColorSize(json);

    var ret6 = isEqual("铁锈红", getTextFieldValue(getScrollView(-1), 13));
    ...
    ret6 = isAnd(ret6, isEqual("铁锈红", getTextFieldValue(getScrollView(-1), 13)));
...
function test170654() {
    ...
    tapMenu("采购入库", "新增入库+");
    var json = { "客户" : "Rt",
        "明细" : [ { "货品" : "anewCuanMa", "数量" : [ Number(-k * 2) ] } ],
        "goodsFieldIndex" : -2 };
    editSalesBillColorSize(json);

    tapMenu("销售开单", "开  单+");
    var json = { "客户" : "ls",
        "明细" : [ { "货品" : "anewCuanMa", "数量" : [ add(-k, 1) ] } ],
        "onlytest" : "yes" };
    editSalesBillColorSize(json);
...
function test170655() {
    ...
    tapMenu("销售订货", "新增订货+");
    var json = { "客户" : "lt",
        "明细" : [ { "货品" : "anewCuanMa", "数量" : [ add(add(k2, k3), 1) ] } ],
        "goodsFieldIndex" : -2 };
    editSalesBillColorSize(json);
    ...
    tapMenu("采购入库", "新增入库+");
    var json = { "客户" : "Rt",
        "明细" : [ { "货品" : "anewCuanMa", "数量" : [ -add(add(k4, k5), 1) ] } ],
        "goodsFieldIndex" : -2, "onlytest" : "yes" };
    editSalesBillColorSize(json);
    ...
    tapMenu("门店调出", "批量调出+");
    var json = { "客户" : "000",
        "明细" : [ { "货品" : "anewCuanMa", "数量" : [ add(add(k6, k7), 1) ] } ],
        "goodsFieldIndex" : -2, "onlytest" : "yes" };
    editSalesBillColorSize(json);
...
function test170656() {
    ...
    var ret2 = isAnd(isEqual(0, add(k3, k2)));

    // 按订货开单/采购退货/门店调出/紧急模式上传 都要测一遍
    tapMenu("销售订货", "新增订货+");
    var json = { "客户" : "lt", "明细" : [ { "货品" : "anewCuanMa", "数量" : [ 1 ] } ],
        "goodsFieldIndex" : -2 };
    editSalesBillColorSize(json);
    ...
    ret5 = isAnd(ret5, isEqual(0, add(k9, k8)));
...
function test170657() {
    ...
    tapMenu("销售开单", "开  单+");
    var json = { "客户" : "ls",
        "明细" : [ { "货品" : "anewCuanMa", "数量" : [ add(-sub(-k1, k), 5) ] } ] };
    editSalesBillColorSize(json);
    ...
    ret3 = isAnd(ret3, isEqual(-5, add(k5, k4)));
    ...
    saveAndAlertOk();
    tapPrompt();
    var ret4 = isAnd(isIn(alertMsg, "差6"));
    ...
    ret4 = isAnd(ret4, isEqual(-5, add(k7, k6)));
...
function test170702() {
    ...
    var ret2 = isAnd(isEqual("x001", getTextFieldValue(getScrollView(-1), 7)),
            isEqual(0, getTextFieldValue(getScrollView(-1), 10)), isEqual("x001",
    ...
    var ret2 = isAnd(isEqual("x001", getTextFieldValue(getScrollView(-1), 21)),
            isEqual(0, getTextFieldValue(getScrollView(-1), 24)), isEqual("x001",
                    getTextFieldValue(getScrollView(-1), 28)), isEqual(1,
                    getTextFieldValue(getScrollView(-1), 31)));
