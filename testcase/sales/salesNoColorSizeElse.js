...
function test170285() {
    ...
    var keys = { "客户" : "ls", "日期从" : getDay(-60), "日期到" : getToday(),
        "物流商" : "圆通速递", "批次从" : "1", "批次到" : num, "门店" : "常青店", "运单号" : "123",
        "是否收款" : "否", "是否作废" : "否" };
    var fields = salesQueryLogisticsFields(keys);
    query(fields);
...
function test170285_1() {
    ...
    var ret3 = isAnd(isEqual("", a), isEqual(getDay(-60), a1), isEqual(
...
function test170340() {
    ...
    var ret1 = isAnd(isEqual("", a), isEqual("", a1), isEqual(getToday(), a2),
            isEqual("", a3), isEqual("", a4), isEqual(getDay(-10), a5),
            isEqual(getToday(), a6));
...
function test170357() {
    ...
    var ret1 = isAnd(isEqual(getDay(-10), b), isEqual(getToday(), b1), isEqual(
            "", b2));
