...
function test170325_1() {
    ...
    var ret1 = isAnd(isEqual(xj1, xj), isEqual(sk1, sk), isEqual(hk1, hk),
            isEqual(ds1, ds), isEqual(sxs1, sxs), isEqual(sxe1, sxe), isEqual(
                    ml1, ml), isEqual(sxe21, sxe2), isEqual(qt1, qt), isEqual(
                    qk1, qk));
