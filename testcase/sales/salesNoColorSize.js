...
function test170056() {
    ...
    var ret1 = isAnd(isEqual("李四 其他店总欠: 0.0", getStaticTextValue(getScrollView(
            -1, 0), 0)), isEqual("常青店", md1), isEqual("李四", kh1), !isEqual(0,
            len));
...
function test170139_2() {
    ...
    var r = "newKuanH2" + getTimestamp(6);
    var r1 = "0." + getTimestamp(3);
    var keys = { "款号" : r, "名称" : r, "进货价" : "100", "产品折扣" : r1 };
    addGoods(keys, colorSize);
...
function test170164() {
    ...
    var ret1 = isAnd(isEqual(sum1, qr.counts["现金"]), isEqual(sum2,
...
function test170492() {
    ...
    var ret4 = isAnd(isEqual("李四", qr.data[0]["客户"]), isEqual(20,
...
function test170672() {
    ...
    var json = {
        ...
        "代收" : { "物流商" : "yt", "运单号" : r1, "备注" : "a" + r1, "代收金额" : "50" },
        "发货" : "仓库店" };
    editSalesBillNoColorSize(json);
...
function test170674_170675() {
    ...
    var ret4 = isAnd(isEqual("仓库店", getTextFieldValue(window, 6)), isEqual(
            5500, getTextFieldValue(window, 9)));
...
function test170676() {
    ...
    var ret = isAnd(isEqual("中洲店", getTextFieldValue(window, 6)), isEqual(5000,
            getTextFieldValue(window, 9)));
...
function test170693() {
    ...
    var ret = isAnd(isEqual(-100, a), isEqual(-1, a1), isEqual(getToday("yy"),
            a2), isEqual("常青店", a3), isEqual("总经理", a4), isEqual("抵现单", a5));
    ...
    logDebug(" a=" + a + ", a1=" + a1 + ", a2=" + a2 + ", ret=" + ret
            + ", ret1=" + ret1);
    return ret && ret1;
}
function test170695() {
...
function test240002_240004() {
    ...
    debugArray(alertMsgs);
    var alertMsg1 = getArray1(alertMsgs, -2);
    var ret = (isIn(alertMsg1, "折扣必须小于等于1"));
...
function test240009() {
    ...
    var ret1 = isAnd(isIn(getTextFieldValue(getScrollView(), 8), r), isEqual(s,
            getTextFieldValue(window, 0)), isEqual(s1, getTextFieldValue(
            getScrollView(), 13)));
