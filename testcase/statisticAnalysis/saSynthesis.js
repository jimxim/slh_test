...
function test190049() {
    ...
    editObj1 = { "明细" : [ { "货品" : "k200", "数量" : 5 } ], "现金" : 300,
        "核销" : [ 5 ] };
    expectedObj1 = { "销数" : 5, "销额" : 1000, "实销数" : 5, "实销额" : 1000, "现金" : 300,
        "欠款" : 700 };
    ret = isAnd(ret, synthesis1(editObj1, expectedObj1));
...
function test190051() {
    ...
    expectedObj1 = { "销数" : 5, "销额" : 1500, "实销数" : 5, "实销额" : 1500, "现金" : 1500 };
    ret = isAnd(ret, synthesis1(editObj1, expectedObj1));
...
function test190061() {
    ...
    editObj1 = { "明细" : [ { "货品" : "k200", "数量" : 5 } ], "现金" : 800,
        "核销" : [ 5 ] };
    expectedObj1 = { "销数" : 5, "销额" : 1000, "实销数" : 5, "实销额" : 1000, "现金" : 800,
        "抵扣" : 200 };
    ret = isAnd(ret, synthesis1(editObj1, expectedObj1));
...
function test190064() {
    ...
    expectedObj1 = { "销数" : 5, "销额" : 1000, "实销数" : 5, "实销额" : 1000, "现金" : 400,
        "欠款" : 600 };
...
function synthesisDebt1000() {
    var editObj1, expectedObj1;
    editObj1 = { "明细" : [ { "货品" : "k200", "数量" : 5 } ], "现金" : 0 };
    expectedObj1 = { "销数" : 5, "销额" : 1000, "实销数" : 5, "实销额" : 1000, "欠款" : 1000 };
    return synthesis1(editObj1, expectedObj1);
}
// 新增1000的一张单子，用于退货
function synthesisCash1000() {
    var editObj1, expectedObj1;
    editObj1 = { "明细" : [ { "货品" : "k200", "数量" : 5 } ] };
    expectedObj1 = { "销数" : 5, "销额" : 1000, "实销数" : 5, "实销额" : 1000, "现金" : 1000 };
    return synthesis1(editObj1, expectedObj1);
}
// 新增余款200的一张单子,用于核销
