...
function test170693() {
    ...
    logDebug(" len=" + len + ", len1=" + len1 + ", ret=" + ret + ", ret1="
            + ret1);
    return ret && ret1;
}
function test170694() {
