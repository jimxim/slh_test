...
function test170065_1_170067_1() {
    // 核销欠款，不输入款号
    tapMenu("销售开单", "开  单+");
    tapButton(window, "新增+");
    var r = "anewkh" + getTimestamp(6);
...
function test170065_2_170067_2() {
    // 核销欠款，输入款号
    tapMenu("销售开单", "开  单+");
    tapButton(window, "新增+");
    var r = "anewkh" + getTimestamp(6);
...
function test170078() {
    ...
    query();
    var qr = getQR();
    var ret2 = isAnd(isEqual("259", qr.data[0]["金额"]), isEqual("259",
            qr.data[0]["现金"]), isEqual("0", qr.data[0]["未结"]));
...
function test170083_1() {
    ...
    tapFirstText();
    var f18 = new TField("拿货折扣", TF, 18, "0.68");
    var fields = [ f18 ];
    setTFieldsValue(getScrollView(), fields);
    ...
    query(qFields);
    tapFirstText();
    var ret1 = isEqual("0.68", getTextFieldValue(getScrollView(), 18));
    tapReturn();
    ...
    var ret2 = isEqual(0.68, getTextFieldValue(window, 10));
