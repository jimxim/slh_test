...
function testSalesNoColorSizeElse001() {
    ...
    run("【销售开单－物流单查询】正常查询", "test170278_170285_170284");
...
function test170264() {
    ...
    var ret1 = isAnd(isEqual(5, sl), isAqualOptime(getOpTime(), opt), isEqual(
            ...
            isEqual("k200,范范", qr.data[1]["货品"]),
            isEqual("0", qr.data[1]["数量"]), isEqual("00000,抹零",
                    qr.data[2]["货品"]), isEqual("-1", qr.data[2]["数量"]),
            isEqual("00001,打包费", qr.data[3]["货品"]), isEqual("1",
                    qr.data[3]["数量"]));
    tapReturn();
...
function test170596() {
    ...
    var f11 = new TField("数量", TF, idx1 + 8, 8);
    var fields = [ f3, f11 ];
    setTFieldsValue(getScrollView(-1), fields);
    ...
    query();
    tapFirstText();
    var f19 = new TField("数量", TF, idx1 + 16, "2");
    var fields = [ f19 ];
    setTFieldsValue(getScrollView(-1), fields);
    ...
    query();
    tapFirstText();
    var f11 = new TField("数量", TF, idx1 + 8, "10");
    var fields = [ f11 ];
    setTFieldsValue(getScrollView(-1), fields);
