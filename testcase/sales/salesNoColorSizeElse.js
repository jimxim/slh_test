...
function test170588_1() {
    ...
    tapMenu("销售开单", "按汇总", "按客户销售");
    var keys = { "日期从" : getDay(-2), "客户" : "ls" };
    var fields = salesCustomerConsumeFields(keys);
    query(fields);
    qr = getQR();

    var ss1 = qr.data[0]["实收"];

    var ret1 = isAnd(isEqual(ss, ss1), isEqual(ss, b4));
