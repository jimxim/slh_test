...
function test170277() {
    ...
    var Recieve;
    tapMenu("销售开单", menu_More, Recieve);
    if (ipadVer >= "7.10") {
        Recieve = "收款单撤销"
    } else {
        Recieve = "撤销"
